...
class Cars:
    def __init__(self):
        ...
        # self.details_tab=Frame(self.notebook)
        ...
        # self.lb_caddress= Label(self.frame1,font=("Calibri",14,"bold"),text="Available address:",bg="#6262ED",fg="white")
        # self.lb_caddress.grid(row=3,column=0)
        ...
        # self.delete_button.place(x=320,y=100)
        ...
        self.exit_button=Button(self.add_tab, text="Exit", font=('Calibri', 11,"bold"), fg="white",background='#C31616',width=15, bd=1)
        ...
        # self.lb_add=Label(self.frame3,text="Address:", fg="Black",font=("Calibri",14,"bold"),bg="#6262ED")
        # self.lb_add.grid(row=6,column=0)

        # self.lb_con=Label(self.frame3,text="Country:", fg="Black",font=("Calibri",14,"bold"),bg="#6262ED")
        # self.lb_con.grid(row=7,column=0)
        ...
        self.orders_tree = ttk.Treeview(self.frame4, columns=('username', 'brand','model', 'pickUpDate','location','days','price'))
        ...
        #=======================================user details tab=====================================#
        # self.frame5=Frame(self.details_tab,bd=5)
        # self.frame5.place(x=0,y=0)
        # self.frame5.configure(background="#6262ED")

        # self.ent_user=Entry(self.frame5,font=("arial",12),width=15)
        # self.ent_user.grid(row=0,column=0,padx=10,pady=10)

        # self.btn4 = Button(self.details_tab, text='Search', font=('Calibri', 11,"bold"), fg="white",background='#6262ED',width=12, bd=1, command=self.searchDetails)
        # self.btn4.place(x=170,y=10)

        # self.frame6=Frame(self.details_tab,bd=5)
        # self.frame6.place(x=0,y=50)
        # self.frame6.configure(background="#6262ED")


        # self.details_tree = ttk.Treeview(self.frame6, columns=('username', 'brand','model', 'pickUpDate','location','days','price'))
        # self.details_tree.grid(row=0, column=0)
        # self.details_tree['show'] = 'headings'
        # self.details_tree.column('username', width=90, anchor='center')
        # self.details_tree.column('brand', width=90, anchor='center')
        # self.details_tree.column('model', width=90, anchor='center')        
        # self.details_tree.column('pickUpDate', width=100, anchor='center')
        # self.details_tree.column('location', width=90, anchor='center')
        # self.details_tree.column('days', width=50, anchor='center')
        # self.details_tree.column('price', width=50, anchor='center')
        # self.details_tree.heading('brand', text="Brand")
        # self.details_tree.heading('username', text="Username")
        # self.details_tree.heading('days', text="Days")
        # self.details_tree.heading('pickUpDate', text="Pick Up")
        # self.details_tree.heading('model', text="Model")
        # self.details_tree.heading('price', text="Price")
        # self.details_tree.heading('location', text="Address")
    ...
    #=============================Button functions for First tab===============================#
    ...
    def rgstr_btn(self):
        ...
        if self.validateUser():
            ...
            # else:
            #     messagebox.showinfo("Information", "Unable to register")
    ...
    def del_order(self):
        ...
        if self.admin.delete_order(oid):
            ...
            messagebox.showerror("Error","Couldn't error")
            self.showOrder()
    ...
    def showOrder(self):
        ...
        for i in data:
            self.orders_tree.insert("", "end",text=i[0] , value=(i[1], i[2], i[3],i[4],i[5],i[6],i[7]))
        # self.cars_tree.bind("<Double-1>", self.select_item)
