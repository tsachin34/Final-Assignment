...
class Log:
    """ This class is made to build a Login System"""
    def __init__(self):
        ...
        #==========All images=====================================#
        self.login_image=ImageTk.PhotoImage(Image.open(
            "D:/Second Semester/Algorithm/Assignment Draft/images/userICon.png"
            ).resize((60,65)))
        self.login_label=Label(self.wn,image=self.login_image,background="#041E77")
        self.login_label.place(x=230,y=10)
        
        self.user_image=ImageTk.PhotoImage(Image.open(
            "D:/Second Semester/Algorithm/Assignment Draft/images/manUser.png"
            ).resize((35,35)))
        self.user_label=Label(self.frame1,image=self.user_image,background='#041E77')
        self.user_label.grid(row=0,column=0)

        self.password_image=ImageTk.PhotoImage(Image.open(
            "D:/Second Semester/Algorithm/Assignment Draft/images/pass4.png"
            ).resize((35,35)))
        self.password_label=Label(self.frame1,image=self.password_image,background='#041E77')
        self.password_label.grid(row=1,column=0)

        self.eye_image=ImageTk.PhotoImage(Image.open(
            "D:/Second Semester/Algorithm/Assignment Draft/images/eye1.png"
            ).resize((30,30)))
       ...
       #=================buttons=====================================#
        self.btn = Button(self.frame1, text='Log in', font=('Calibri', 14,"bold"), 
        fg="white",background='#041E77',width=20, bd=0.5, command=self.login_onclick)
        self.btn.grid(row=2,column=2,pady=10)

        self.btn4= Button(self.frame1,text="Exit",font=('Calibri', 14,"bold"), 
        fg="white",background='red',width=20, bd=0.5, command=self.exitWn)
